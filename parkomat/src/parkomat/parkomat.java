...
public class parkomat extends JFrame {
    ...
    private void handleKeyPress(String key) {
        ...
        if (key.equals("←")) {
            ...
            if (activeField == regInput) {
                ...
                if (key.matches("[0-9\\.]"))
                    manualAmountField.setText(manualAmountField.getText() + key);
            }
        }
        updatePrintButtonState();
    }
    ...
    private void updatePrintButtonState() {
        ...
        if (inserted >= cost) {
            printBtn.setEnabled(true);
            statusLabel.setText("Reszta: " + df.format(inserted - cost) + " zł");
        } else {
    ...
    private void validateAndGenerateTicket() {
        ...
        ticketOutput.setText(
                "==============================\n" +
                        ...
                        "Czas: " + hours + "h\n" +
                        "Cena: " + df.format(cost) + " zł\n" +
                        (selectedPayment.equals("Karta") ? "Płatność kartą — OK\n" :
